...
import com.paise.paiseAutomatizado.api.repositorios.LancamentoRepository;
...
public class LancamentoServiceTest {
	...
	public void setUp() throws Exception {
		...
		BDDMockito.doNothing().when(this.lancamentoRepository).delete(Mockito.any(Lancamento.class)); 
	}
